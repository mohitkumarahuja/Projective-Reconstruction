function [ Y ] = Calculate_Proj( X )
% Calculate_Proj  Contraction with epsilon tensor.
%
% B = Calculate_Proj(A) is tensor obtained by contraction of A with epsilon tensor.
...
% It is Calculate_Proj(Calculate_Proj(A)) = A.
